...
var ie6 = $.support.msie && /MSIE 6.0/.test(navigator.userAgent);
var pageBlock = null;
var pageBlockEls = [];
...
function install(el, opts) {
    ...
    var lyr1 = ($.support.msie) ? $('<iframe class="blockUI" style="z-index:'+ (z++) +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="about:blank"></iframe>')
    ...
    // style the overlay
    if (!opts.applyPlatformOpacityRules || !($.support.mozilla && /Linux/.test(navigator.platform)))
    ...
    var expr = $.support.msie && ($.support.version < 8 || !$.boxModel) && (!$.boxModel || $('object,embed', full ? null : el).length > 0);
	...
	if ($.support.msie && opts.showOverlay)
